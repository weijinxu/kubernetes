...
func (a *ResourceQuotaAdapter) FedUpdateStatus(obj pkgruntime.Object) (pkgruntime.Object, error) {
	resourcequota := obj.(*apiv1.ResourceQuota)
	return a.client.CoreV1().ResourceQuotas(resourcequota.Namespace).UpdateStatus(resourcequota)
}
